...
describe("HomePage", () => {
  describe("基本表示", () => {
    ...
    it("ウェルカムメッセージが表示される", async () => {
      ...
      expect(screen.getByText(/This is a sample Single Page Application/)).toBeInTheDocument();
    });
  });
  ...
  describe("カードセクション", () => {
    it("Task Managerカードが表示される", async () => {
      ...
      expect(screen.getByText(/A full-featured task management application/)).toBeInTheDocument();
    ...
    it("About Pageカードが表示される", async () => {
      ...
      expect(screen.getByText(/Learn more about this application/)).toBeInTheDocument();
    ...
    it("Users Pageカードが表示される", async () => {
      ...
      expect(screen.getByText(/View a list of users and their profiles/)).toBeInTheDocument();
    ...
    it("Featuresカードが表示される", async () => {
      ...
      expect(
        screen.getByText(/Modern React with hooks and functional components/),
      ).toBeInTheDocument();
